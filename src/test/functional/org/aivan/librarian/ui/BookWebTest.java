...
public class BookWebTest {
  ...
  public void testDeleteBook() {
    beginAt("/");
    clickLink("deleteBookLink_2");
    assertTitleEquals("Librarian - Delete Book");
    clickButton(BookController.PARAM_DELETE_BUTTON);
    assertTitleEquals("Librarian - Book deleted");
    clickLink("homeLink");
    assertTitleEquals("Librarian Home Page");
  }
