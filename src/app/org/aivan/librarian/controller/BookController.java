...
public class BookController {
  ...
  public static final String VIEW_DELETE_BOOK = "delete_book";
  public static final String VIEW_DELETE_BOOK_DONE = "delete_book_done";
  ...
  public static final String PARAM_DELETE_BUTTON = "deleteButton";
  ...
  @RequestMapping(value = URL_DELETE_BOOK)
  public String deleteBook(@RequestParam(PARAM_ID) Long id, Model model) {
    Book book = bookService.getBook(id);
    model.addAttribute(ATTR_BOOK, book);
    return VIEW_DELETE_BOOK;
  }

  @RequestMapping(value = URL_DELETE_BOOK, params = PARAM_DELETE_BUTTON)
  public String deleteBookConfirm(@RequestParam(PARAM_ID) Long id, Model model) {
    bookService.deleteBook(id);
    return VIEW_DELETE_BOOK_DONE;
  }
